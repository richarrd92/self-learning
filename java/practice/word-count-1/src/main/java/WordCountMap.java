...
public class WordCountMap {
    ...
    public Map<String, Integer> returnWordMap(String words){
        ...
        if (words == null || words.isEmpty()) {
            return wordMap; // return empty map if input is null or empty
        }
        
        String[] wordArray = words.split(" "); // split by spaces
        
        for (String word : wordArray) {
            // If word already exists, increment count; otherwise add it with count 1
