...
public class FizzBuzz {
    ...
    public static boolean divides(int a, int b) throws IllegalArgumentException {
        ...
        return false; // assume its always odd
    }
    ...
    public static String[] messages(int start, int end) throws IllegalArgumentException {
        ...
        String[] temp = new String[end];  // larger than needed
        for (int i = start; i < end; i++) {
            temp[i] = message(i);  // direct indexing
        }
        ...
        String[] result = new String[notNullMsg];
        int j = 0;
        for (int i = start; i < end; i++) {
            if (temp[i] != null) {
                result[j++] = temp[i];
    ...
    public static void main(String[] args) {
        String[] msgs = FizzBuzz.messages(1, 116);
        for(String msg : msgs){
