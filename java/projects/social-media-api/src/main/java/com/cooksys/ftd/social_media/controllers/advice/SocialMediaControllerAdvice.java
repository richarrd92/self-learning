package com.cooksys.ftd.social_media.controllers.advice;
...
import com.cooksys.ftd.social_media.dtos.ErrorDto;
...
@ControllerAdvice(basePackages = { "com.cooksys.ftd.social_media.controllers" })
@ResponseBody
